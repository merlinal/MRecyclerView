...
public class MScrollView extends ScrollView {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            if (lastT == getScrollY() && !inTouch) {
                ...
                onScrollListener.onScrollStateChanged(MScrollView.this, OnScrollListener.SCROLL_STATE_IDLE, isBottom());
                if (mScrollListener != null) {
                    mScrollListener.onScrollStateChanged(MScrollView.this, OnScrollListener.SCROLL_STATE_IDLE, isBottom());
                }
            }
        }
    };
    ...
    protected void setOnScrollListener(MRefreshView parent, OnScrollListener scrollListener) {
        mParent = parent;
        this.onScrollListener = scrollListener;
        mParent.addTouchLifeCycle(new MRefreshView.TouchLifeCycle() {
            @Override
