...
public class RecyclerGridDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerGridDecoration(Context context, int orientation, int height, int offsetStart, int offsetEnd, int color) {
    ...
    private boolean isHideDivider(RecyclerView parent, int pos, int childCount) {
        return pos < mOffsetStart || pos >= childCount - mOffsetEnd;
    }
